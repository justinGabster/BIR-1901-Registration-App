        ...
        <div className="max-w-md mx-auto w-full px-6 flex-1 flex flex-col justify-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-2">
              <h1 className="text-2xl sm:text-3xl font-black text-[var(--color-accent-primary)]">Welcome back</h1>
              <p className="text-sm sm:text-base text-[var(--color-text-secondary)]">Log in to your <span className="text-[var(--color-accent-primary)] font-semibold">registration account</span></p>
            </div>
